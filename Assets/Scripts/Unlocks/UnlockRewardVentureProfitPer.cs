...
public class UnlockRewardVentureProfitPer : IUnlockReward
{
	...
	{
		string plural = state.VentureModels.FirstOrDefault((VentureModel v) => v.Id == this.affectedVenture).Plural;
	...
	{
		string name = state.VentureModels.FirstOrDefault((VentureModel v) => v.Id == this.affectedVenture).Name;
	...
	{
		state.VentureModels.FirstOrDefault((VentureModel v) => v.Id == this.affectedVenture).ProfitPer.Value *= this.profitBonus;
	}
}
