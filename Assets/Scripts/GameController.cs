...
public sealed class GameController : IGameController, IDisposable
{
    ...
    public AdWatchService AdWatchService { get; private set; }

    // Token: 0x170000A9 RID: 169
    // (get) Token: 0x06000A12 RID: 2578 RVA: 0x0002CEB4 File Offset: 0x0002B0B4
    ...
    // (get) Token: 0x06000A18 RID: 2584 RVA: 0x0002CEE7 File Offset: 0x0002B0E7
    // (set) Token: 0x06000A19 RID: 2585 RVA: 0x0002CEEF File Offset: 0x0002B0EF
    public RedemptionService RedemptionService { get; private set; }

    // Token: 0x170000AD RID: 173
    // (get) Token: 0x06000A1A RID: 2586 RVA: 0x0002CEF8 File Offset: 0x0002B0F8
    ...
    // (get) Token: 0x06000A22 RID: 2594 RVA: 0x0002CF3C File Offset: 0x0002B13C
    // (set) Token: 0x06000A23 RID: 2595 RVA: 0x0002CF44 File Offset: 0x0002B144
    public PlatformAchievementService PlatformAchievementService { get; private set; }

    // Token: 0x170000B2 RID: 178
    // (get) Token: 0x06000A24 RID: 2596 RVA: 0x0002CF4D File Offset: 0x0002B14D
    // (set) Token: 0x06000A25 RID: 2597 RVA: 0x0002CF55 File Offset: 0x0002B155
    public FreeloaderAdService FreeloaderAdService { get; private set; }

    // Token: 0x170000B3 RID: 179
    // (get) Token: 0x06000A26 RID: 2598 RVA: 0x0002CF5E File Offset: 0x0002B15E
    // (set) Token: 0x06000A27 RID: 2599 RVA: 0x0002CF66 File Offset: 0x0002B166
    ...
    // (get) Token: 0x06000A31 RID: 2609 RVA: 0x0002CFBA File Offset: 0x0002B1BA
    ...
    // (set) Token: 0x06000A36 RID: 2614 RVA: 0x0002CFE4 File Offset: 0x0002B1E4
    public ScheduledOfferService ScheduledOfferService { get; private set; }
    ...
    public GameController()
    {
        ...
        this.FreeloaderAdService = new FreeloaderAdService();
        ...
        this.ScheduledOfferService = new ScheduledOfferService();
                    ...
                    Action<bool> onNext =( (b)=>
                        {
                            ...
                            this.OfferwallService.Init(this.GrantRewardService, this.ScheduledOfferService);
                            this.ServerMessageService.Init();
                            this.RedemptionService.Init();
                            ...
                            this.EventMissionsService.Init(this, this.DateTimeService, this.TimerService, this.AngelService, this.StoreService, this.AdWatchService, this.UpgradeService, this.EventService, this.AnalyticService, this.ProfitBoostAdService);
    ...
    public void ResetGame(bool isAdwatch = false)
    {
        ...
        if (this.FreeloaderAdService.TryAndShowAdAfterAngelClaim && this.FreeloaderAdService.ShouldShowAd.Value)
        {
            this.FreeloaderAdService.WatchAd("AngelClaim").Subscribe(delegate (Unit adWatchSuccess)
            {
                this.AnalyticService.SendAdFinished("AngelClaim", "Interstitial", this.game.planetName, "");
            }, delegate (Exception adWatchError)
            {
                bool value = Helper.GetPlatformAd().AdReadyMap[AdType.Interstitial].Value;
                bool value2 = Helper.GetPlatformAd().AdReadyMap[AdType.RewardedVideo].Value;
                this.AnalyticService.SendAdFinished("AngelClaim", "Error=" + adWatchError, this.game.planetName, value2.ToString() + ":" + value.ToString());
            });
        }
    }
    ...
    private void OnApplicationPause(bool paused)
    {
        ...
        {
            TimeSpan timeSpan = this.DateTimeService.UtcNow - this.pauseTime;
            this.ApplyElapsedOfflineTime(timeSpan.TotalSeconds);
            this.TimerService.AddTimeToAll(TimeSpan.FromSeconds(timeSpan.TotalSeconds), true);
        }, delegate (Exception error)
        {
            GameController.Instance.AnalyticService.SendTaskCompleteEvent("FailedToRetrieveTime", "ApplicationResume", "");
            GameController.Instance.NavigationService.CreateModal<PopupModal>(NavModals.POPUP, false).WireData("Error", "We ran into a problem retrieving the server time!!", delegate ()
            {
                this.LoadPlanetScene("Earth", false);
            }, PopupModal.PopupOptions.OK, "Return to Earth", "", false, null, "");
        }).AddTo(this.stateDisposables);
    }
    ...
    // Token: 0x06000A6E RID: 2670 RVA: 0x0002E578 File Offset: 0x0002C778
